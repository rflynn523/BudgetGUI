...
# Make the buttons
# Add Entry Button
tk.Button(info.window, text="New Entry", font = "Calibri 12 bold", relief = 'groove', bg="mediumseagreen",
          activebackground = "darkolivegreen", command=addEntry.createEntryWindow).grid(row=12, column = 0, sticky=tk.W, padx=5, pady=5)

# New Month button
tk.Button(info.window, text="New Month", font = "Calibri 12 bold", relief = 'groove', bg="mediumseagreen",
          activebackground = "darkolivegreen", command=newMonth.new_month).grid(row=12, column=1, sticky=tk.W, padx=5, pady=5)
